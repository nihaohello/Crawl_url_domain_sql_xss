...
class crawl(object):
    ...
    def file_save(self):
        mutex4.acquire()
        with open(self.file_name+"crawl_urls.txt", "a+",encoding="utf-8") as f:
    ...
    def file_domain_save(self):
        ...
        with open(self.file_name+"crawl_doamin.txt", "a+",encoding="utf-8") as f:
    ...
    def sql_xss_file_save(self):
        ...
        with open(self.file_name+"crawl_sql_xss.txt", "a+",encoding="utf-8") as f:
